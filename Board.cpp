...
board::board(QGraphicsScene * g)
{
    ...
    QFile file("/Users/khalednana/Desktop/paccc/Board.txt");
    ...
    QPixmap edgeImageH("/Users/khalednana/Desktop/paccc/PacmanGame-master/Assets/edgeH.png");
    edgeImageH = edgeImageH.scaledToWidth(blockDim);
    edgeImageH = edgeImageH.scaledToHeight(blockDim);
    QPixmap edgeImageV("/Users/khalednana/Desktop/paccc/PacmanGame-master/Assets/edgeV.png");
    edgeImageV = edgeImageV.scaledToWidth(blockDim);
    edgeImageV = edgeImageV.scaledToHeight(blockDim);
    QPixmap cornerImageTL("/Users/khalednana/Desktop/paccc/PacmanGame-master/Assets/cornerTL.png");
    cornerImageTL = cornerImageTL.scaledToWidth(blockDim);
    cornerImageTL = cornerImageTL.scaledToHeight(blockDim);
    QPixmap cornerImageTR("/Users/khalednana/Desktop/paccc/PacmanGame-master/Assets/cornerTR.png");
    cornerImageTR = cornerImageTR.scaledToWidth(blockDim);
    cornerImageTR = cornerImageTR.scaledToHeight(blockDim);
    QPixmap cornerImageBR("/Users/khalednana/Desktop/paccc/PacmanGame-master/Assets/cornerBR.png");
    cornerImageBR = cornerImageBR.scaledToWidth(blockDim);
    cornerImageBR = cornerImageBR.scaledToHeight(blockDim);
    QPixmap cornerImageBL("/Users/khalednana/Desktop/paccc/PacmanGame-master/Assets/cornerBL.png");
